              ...
              {contactInfo.map((item, index) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center p-4 sm:p-6 bg-gray-50 border border-gray-200 rounded-xl shadow-md hover:bg-gray-100 transition-colors duration-300 transform hover:translate-x-2"
                  >
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-500 to-green-500 rounded-full flex items-center justify-center">
          ...
          <div className="bg-gray-100 rounded-2xl p-6 sm:p-8 text-gray-900 shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <a
                ...
                className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-500 to-green-500 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-green-600 transition-all duration-300 transform hover:scale-105 text-sm sm:text-base"
              >
                Email Me Directly
              </a>
              <a
                href="tel:+919503474561"
                className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-gray-400 text-gray-800 font-semibold rounded-lg hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 text-sm sm:text-base"
              >
                Call Me Now
              </a>
            </div>
