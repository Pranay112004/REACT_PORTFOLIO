    ...
    <section id="about" className="py-12 sm:py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-700 mt-6">Get to know me better</p>
        </div>
          ...
          <div className="order-2 lg:order-1">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="mt-6 sm:mt-8">
                <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-4 text-center lg:text-left">What I Do</h3>
                <ul className="space-y-3 max-w-md mx-auto lg:mx-0">
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-3 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base text-gray-700">Full-Stack Web Development</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-green-500 rounded-full mr-3 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base text-gray-700">Responsive Design & UI/UX</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-purple-500 rounded-full mr-3 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base text-gray-700">Database Design & Management</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-yellow-500 rounded-full mr-3 flex-shrink-0"></div>
                    <span className="text-sm sm:text-base text-gray-700">API Development & Integration</span>
                  </li>
                </ul>
              </div>
            </div>
